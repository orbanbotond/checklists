...
describe RecipisController do
  render_views
  describe "index" do
    before do
      Recipi.create!(name: 'Baked Potato w/ Cheese')
      Recipi.create!(name: 'Garlic Mashed Potatoes')
      Recipi.create!(name: 'Potatoes Au Gratin')
      Recipi.create!(name: 'Baked Brussel Sprouts')
